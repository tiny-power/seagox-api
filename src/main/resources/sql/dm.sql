...
CREATE TABLE IF NOT EXISTS "public"."construction_log" (
    ...
    "next_day_plan" CLOB DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."inspection_participant" (
    ...
    "signature_url" VARCHAR(1500) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."issue_ticket" (
    ...
    "resolution" VARCHAR(600) DEFAULT NULL,
    "status" INTEGER DEFAULT 1,
    "created_by" BIGINT NOT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_by" BIGINT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."operation_log" (
    ...
    "actor_name" VARCHAR(300) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."sys_process_draft" (
	...
	"business_title" VARCHAR(600) NOT NULL,
...
INSERT INTO "public"."sys_menu" VALUES (41,1,26,2,'知识库','iconfont icon-xihuan','disk',1,2,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
...
INSERT INTO "public"."sys_menu" VALUES (62,1,58,3,'提交','iconfont icon-xihuan','paymentRequest:submit',1,4,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (63,1,58,3,'撤销','iconfont icon-xihuan','paymentRequest:cancel',1,5,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (64,1,36,2,'施工图出图','iconfont icon-xihuan','constructionDrawing',1,5,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (65,1,64,3,'新增','iconfont icon-xihuan','constructionDrawing:add',1,1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (66,1,64,3,'编辑','iconfont icon-xihuan','constructionDrawing:edit',1,2,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (67,1,64,3,'提交','iconfont icon-xihuan','constructionDrawing:submit',1,3,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (68,1,64,3,'确认阅读','iconfont icon-xihuan','constructionDrawing:confirmRead',1,4,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (69,1,64,3,'取消归档','iconfont icon-xihuan','constructionDrawing:cancelArchive',1,5,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (70,1,64,3,'删除','iconfont icon-xihuan','constructionDrawing:delete',1,6,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (71,1,36,2,'施工日志','iconfont icon-xihuan','constructionLog',1,6,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (72,1,71,3,'新增','iconfont icon-xihuan','constructionLog:add',1,1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (73,1,71,3,'编辑','iconfont icon-xihuan','constructionLog:edit',1,2,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (74,1,71,3,'删除','iconfont icon-xihuan','constructionLog:delete',1,3,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (75,1,36,2,'验收单','iconfont icon-xihuan','inspection',1,7,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (76,1,75,3,'新增','iconfont icon-xihuan','inspection:add',1,1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (77,1,75,3,'编辑','iconfont icon-xihuan','inspection:edit',1,2,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (78,1,75,3,'完成','iconfont icon-xihuan','inspection:complete',1,3,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (79,1,75,3,'删除','iconfont icon-xihuan','inspection:delete',1,4,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (80,1,36,2,'问题单','iconfont icon-xihuan','issueTicket',1,8,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (81,1,80,3,'新增','iconfont icon-xihuan','issueTicket:add',1,1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (82,1,80,3,'编辑','iconfont icon-xihuan','issueTicket:edit',1,2,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (83,1,80,3,'指派整改','iconfont icon-xihuan','issueTicket:assign',1,3,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (84,1,80,3,'提交整改','iconfont icon-xihuan','issueTicket:rectify',1,4,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (85,1,80,3,'复验','iconfont icon-xihuan','issueTicket:review',1,5,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (86,1,80,3,'删除','iconfont icon-xihuan','issueTicket:delete',1,6,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (87,1,36,2,'材料到场','iconfont icon-xihuan','materialArrival',1,9,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (88,1,87,3,'新增','iconfont icon-xihuan','materialArrival:add',1,1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (89,1,87,3,'删除','iconfont icon-xihuan','materialArrival:delete',1,2,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO "public"."sys_menu" VALUES (90,1,36,2,'交接单','iconfont icon-xihuan','projectHandover',1,10,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
...
INSERT INTO "public"."sys_menu" VALUES (94,1,36,2,'案例库','iconfont icon-xihuan','designCase',1,12,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
