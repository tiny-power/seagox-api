...
INSERT INTO "public"."sys_menu" VALUES (98,1,36,2,'科普管理','iconfont icon-xihuan','knowledge',1,13,now(),now()),(99,1,98,3,'新增','iconfont icon-xihuan','knowledge:add',1,1,now(),now()),(100,1,98,3,'编辑','iconfont icon-xihuan','knowledge:edit',1,2,now(),now()),(101,1,98,3,'删除','iconfont icon-xihuan','knowledge:delete',1,3,now(),now());
